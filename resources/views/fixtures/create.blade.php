...
<div class="row homepage-spacer">
    <p><a href="{{ route('homepage.index') }}">Home</a></p>
    <h1>Add fixtures</h1>
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('fixtures.store') }}">
                    @csrf
                    {!! Form::hidden('highestSeasonId', $highestSeasonId) !!}


                    <div class="form-group row">
                        <label for="competition_id" class="col-md-4 col-form-label text-md-right">{{ __('Competition') }}</label>

                        <div class="col-md-6">
                            {!! Form::select('competition_id', ['' => 'Select Competition'] + $competitions->toArray(), null, ['class' => 'form-control']) !!}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            {!! Form::select('home_team_id', ['' => 'Select Home Team'] + $teams->toArray(), null, ['class' => 'form-control']) !!}
                            @error('home_team_id')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
